...
* [Посібник користувача для апаратури з кольоровим екраном](color-radios/README.md)
  ...
  * [Параметри моделі](color-radios/model-settings/README.md)
    * [Налаштування моделі](color-radios/model-settings/model-setup/README.md)
      ...
      * [Користувацькі перемикачі](color-radios/model-settings/model-setup/customizable-switches.md)
      * [Інше](color-radios/model-settings/model-setup/other.md)
  ...
  * [Налаштування системи](color-radios/radio-settings/README.md)
    * [Інструменти](color-radios/radio-settings/tools.md)
    * [SD картка](color-radios/radio-settings/sd-card.md)
...
* [Посібник користувача для апаратури з монохромним екраном](bw-radios/README.md)
  ...
  * [Параметри моделі](bw-radios/model-select/README.md)
    * [Налаштування](bw-radios/model-select/setup.md)
  ...
  * [Налаштування системи](bw-radios/radio-settings/README.md)
