...
3. Для подання нових статей з інструкціями, будь ласка, підготуйте свою статтю у форматі MS Word, Google Docs або Markdown. Для узгодженості використовуйте знімки екрана з симулятора EdgeTX для ілюстрацій. Роздільна здатність зображень має бути 480 x 272 пікселів, якщо це можливо. Надішліть свою статтю як Issue з прикріпленою пропозицією. Після цього її буде розглянуто, і, якщо схвалено, один із редакторів додасть її до бази знань. Якщо ви бажаєте працювати над однією з запитаних інструкцій зі списку Issues, будь ласка, залиште коментар у Issue, що ви працюєте над ним, щоб ніхто інший не взявся за ту саму роботу. Після завершення прикріпіть свою роботу до Issue для перегляду.
