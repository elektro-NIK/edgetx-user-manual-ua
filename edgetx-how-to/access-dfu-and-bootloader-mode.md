...
**Завантажувач**: Вимкніть апаратуру. З’єднайте обидва горизонтальні тримери (TR3 та TR4) один до одного та натисніть кнопку живлення.

**DFU**: Вимкніть апаратуру. Натисніть і утримуйте кнопку DFU (обведену на зображенні нижче) та підключіть USB-кабель, відпустіть кнопку DFU.
...
**DFU**: Вимкніть апаратуру. Під'єднайте кабель USB від комп’ютера до неї. Утримуйте кнопку Boot, потім натисніть і утримуйте кнопку живлення. Екран залишатиметься темним, світлодіоди горітимуть зліва направо. Апаратура знаходиться у режимі DFU.
...
**DFU**: Вимкніть апаратуру. Натисніть і утримуйте кнопку DFU, під'єднайте кабель USB, відпустіть кнопку DFU.
...
**DFU**: Вимкніть апаратуру. Підключіть кабель USB до порту USB у верхній частині радіоапаратури (кнопка живлення засвітиться). Натисніть перемикач SG і тоді натисніть й відпустіть кнопку живлення (потрібно тільки миттєве натискання). Тепер можете відпустити SG.
