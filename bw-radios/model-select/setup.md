...
**Завжди увімк. групи (Always on groups)**
...
**Почат. позиція (Startup Position)**
...
Розширений режим джойстика недоступний для апаратур з чорно-білим дисплеєм та об'ємом флеш-пам'яті менше 1 МБ, оскільки ця функція не вписується в доступний обсяг пам'яті.
{% endhint %}
