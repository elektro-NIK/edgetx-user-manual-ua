...
Екран **Мікшери** показує вам огляд ваших налаштованих мікшерів. Кожен рядок являє собою лінію мікшування і відображає наступну інформацію зліва направо: канал, вага, вхід, ім'я мікшера, перемикач. Ці елементи описані в розділі [Екран налаштування мікшерів](mixes.md#ekran-nalashtuvannya-miksheriv) нижче.
...
* **Weight**- Відсоток значення джерела, який буде використаний. Додатково до фізичних елементів ви можете обрати MAX (завжди повертає 100), MIN (завжди повертає -100), циклічний вихід, тример, значення каналу, глобальну змінну та інше. Розміщення фізичного елементу після джерела автоматично вибере відображення цього значення на поточний вхід. Натисніть довго **\[Enter]** для вибору категорії доступних джерел.
