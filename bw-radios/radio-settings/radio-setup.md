...
**ОбКодРеж** (Режим обертального енкодера) - встановлює напрямок обертального енкодера для Ролера. Варіанти:
...
<figure><img src="../../.gitbook/assets/bwEnabledFeatures.png" alt=""><figcaption><p>Увімкнені функції</p></figcaption></figure>
