...
* c480x272.zip (Горизонтальний кольоровий екран 480x272) - TX16s, T16, Horus x10s, Horus x12s, більшість апаратур з кольоровим екраном...
...
Завантажте потрібний звуковий пакет (якщо ви не перенесли свої наявні звуки) ([https://github.com/EdgeTX/edgetx-sdcard-sounds/releases](https://github.com/EdgeTX/edgetx-sdcard-sounds/releases)), розпакуйте його та скопіюйте до папки "Sounds" на вашій SD-картці.
