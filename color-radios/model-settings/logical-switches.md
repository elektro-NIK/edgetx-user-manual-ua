...
* **Persistence** (лише для залипаючих перемикачів) – Зберігає значення залипаючого перемикача під час вимкнення радіоапаратури або зміни моделі, а також відновлює збережене значення під час увімкнення або повторного вибору моделі.
