...
**Потенціометри та слайдери (Pots & Sliders) -** При активації ця опція перевіряє положення потенціометрів і слайдерів. Є три режими: OFF, ON та AUTO. Якщо у випадаючому меню вибрано **ON** або **AUTO**, з’являться кнопки доступних потенціометрів та повзунків.
