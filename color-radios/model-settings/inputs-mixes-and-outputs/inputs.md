...
<figure><img src="../../../.gitbook/assets/color_model_inputs.png" alt=""><figcaption><p>Екран Входів у Налаштуваннях Моделі</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/color_model_input_edit.png" alt=""><figcaption><p>Сторінка налаштування входу</p></figcaption></figure>
...
* **Weight** - Відсоткове значення ходу стіка, яке потрібно використовувати (часто називається "rates"). In addition to percentage value, you can use other inputs, physical controls, MAX (always returns 100), MIN (always returns -100), cyclics, trim switches, channel values and more, using the "SRC" button.
* **Offset** - Значення, яке додається до або віднімається від джерела входу In addition to percentage value, you can use other inputs, physical controls, MAX (always returns 100), MIN (always returns -100), cyclics, trim switches, channel values and more, using the "SRC" button.
...
* **Curve** - Вказує тип кривої, яка буде використана. Існують такі варіанти кривих:
  * **Diff** - Множить тільки діапазон вище або нижче середнього (0) на вказаний %. In addition to percentage value, you can use other inputs, physical controls, MAX (always returns 100), MIN (always returns -100), cyclics, trim switches, channel values and more, using the "SRC" button.&#x20;
  * **Expo** - Значення входу змінюється експоненційно. Збільшення % призведе до плавнішого нахилу біля середнього (0). Зменшення % призведе до різкішого нахилу біля середнього (0). При 0% нахил буде лінійним. In addition to percentage value, you can use other inputs, physical controls, MAX (always returns 100), MIN (always returns -100), cyclics, trim switches, channel values and more, using the "SRC" button.
  *   **Func** -
