...
* **Weight** - Відсоток значення джерела, який буде використаний. In addition to percentage value, you can select sticks, pots, sliders, trims, physical and logical switches, heli mixer outputs, trainer import channel values, and other channels, using the "SRC" button.
* **Offset** - Значення, яке додається або віднімається від джерела. In addition to a fixed value, you can select sticks, pots, sliders, trims, physical and logical switches, heli mixer outputs, trainer import channel values, and other channels, using the "SRC" button.
