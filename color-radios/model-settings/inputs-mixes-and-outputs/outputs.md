...
<figure><img src="../../../.gitbook/assets/outputs.jpg" alt=""><figcaption><p>Екран Виходи</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/outputs2.jpg" alt=""><figcaption><p>Сторінка конфігурації виходу</p></figcaption></figure>
...
* **Curve** - Вкажіть користувацьку криву (будь-яку), яку ви хочете використовувати для цього виходу. Дивіться розділ [Криві](https://elektronik.gitbook.io/edgetx-ua/color-radios/model-settings/curves) для отримання додаткової інформації про користувацькі криві.
