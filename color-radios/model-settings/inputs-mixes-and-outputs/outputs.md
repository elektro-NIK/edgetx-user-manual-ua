...
* **Min** - Мінімальна межа виходу. Зазвичай використовується для запобігання заклинюванню сервоприводів на моделях, що використовують сервоприводи для керуючих поверхонь. Цей рядок буде виділено **жирним шрифтом та підсвічено**, якщо вхідний сигнал для цього каналу знаходиться в нижній половині діапазону.
* **Max** - Максимальна межа виходу. Зазвичай використовується для запобігання заклинюванню сервоприводів на моделях, що використовують сервоприводи для керуючих поверхонь. Цей рядок буде виділено **жирним шрифтом та підсвічено**, якщо вхідний сигнал для цього каналу знаходиться у верхній половині діапазону.
