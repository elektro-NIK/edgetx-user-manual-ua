...
<figure><img src="../../../.gitbook/assets/RadioSetup.png" alt=""><figcaption><p>Екран налаштування апаратури</p></figcaption></figure>
...
**Затримка вимкнення (Pwr Off delay)** - затримка між натисканням кнопки живлення та моментом вимкнення радіоапаратури. Можливі варіанти: **0s, 1s, 2s, 3s, 4s**. _Рекомендується встановити затримку не менше 1 секунди, щоб запобігти вимкненню апаратури в разі випадкового натискання кнопки._
