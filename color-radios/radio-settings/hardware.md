...
{% hint style="info" %}
Для калібрування стіків/осей використовуйте рухи зліва направо і знизу вгору, а не кругові! Також застосовуйте нормальний рівень тиску на кінцевих точках. Надмірний тиск на кінці може призвести до неправильного калібрування стіків/осей.
{% endhint %}

{% hint style="info" %}
Якщо ваша апаратура має 6-позиційний перемикач (не плутайте із користувацькими перемикачами - вони не потребують калібрування), то процедура його калібрування полягає в послідовному натисканні кожної кнопки в напрямку зліва направо із затримкою в одну секунду між кожним натисканням (це потрібно робити під час загальної процедури калібрування, разом із стіками й потенціометрами/слайдерами).
{% endhint %}
