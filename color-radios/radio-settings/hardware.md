...
{% hint style="info" %}
Для калібрування стіків використовуйте рухи зліва направо і знизу вгору, а не кругові! Також застосовуйте нормальний рівень тиску на кінцевих точках. Надмірний тиск на кінці може призвести до неправильного калібрування стіків.
{% endhint %}

{% hint style="info" %}
Якщо ваша радіоапаратура має 6-позиційний перемикач (не плутати з користувацькими перемикачами — вони не потребують калібрування), процедура калібрування полягає в натисканні кожної кнопки по черзі зліва направо, з паузою в одну секунду між кожним натисканням, на екорані калібрування аналогових входів, таких як стіки/осі, потенціометри та слайдери.
{% endhint %}
