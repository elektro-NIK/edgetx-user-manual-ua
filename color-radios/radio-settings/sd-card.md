...
* **Functions** - у цій папці мають бути розміщені функції сценаріїв Lua, які можна активувати спеціальною функцією **Lua Script**. За замовчуванням ця папка порожня (за винятком файлу readme.txt). Більше інформації про функцій сценаріїв Lua можна знайти тут: [Function Scripts](https://luadoc.edgetx.org/part_i_-_script_type_overview/function_scripts).
